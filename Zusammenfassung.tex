...
\centering
\includegraphics[scale=.25]{pictures/logphy.png}
\caption{Logisch zu Physisch}
\end{minipage}
\hfill
\begin{minipage}[t]{.33\textwidth}
\centering
\includegraphics[scale=.2]{pictures/adform.png}
\caption{Adressformat}
\end{minipage}
\hfill
\begin{minipage}[t]{.33\textwidth}
\centering
\includegraphics[scale=.25]{pictures/virtphy.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.45]{pictures/seitentabelle.png}
...
\centering
\vspace{5mm}
\includegraphics[scale=.3]{pictures/worktlb.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.75]{pictures/bsplru.png}
...
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.2]{pictures/mehrseit0.png}
\caption{Problem großer Seitentabellen}
\end{minipage}
\hfill
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.3]{pictures/mehrseit1.png}
\caption{Idee mehrstufiger Seitentabelle}
\end{minipage}
\\[1em]
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.2]{pictures/mehrseit2.png}
\caption{Beispiel zur mehrstufigen Seitentabelle}
\end{minipage}
\hfill
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.2]{pictures/mehrseit3.png}
...
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.35]{pictures/speicherhierarchie.png}
\caption{Speicherhierarchie}
\end{minipage}
\hfill
\begin{minipage}[t]{.45\textwidth}
\centering
\includegraphics[scale=.3]{pictures/presentbit.png}
\caption{Present Bit}
\end{minipage}
\end{figure}
